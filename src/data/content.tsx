...
export const headerSection = {
  title: "STYLE HUB",
  heading: "Fashion Delivered in 10 Minutes",
};
...
export const midText =
  "Explore our curated selection of high-quality men’s and women’s clothing, featuring stylish trousers and jackets, all delivered to your door in just 10 minutes.";
...
export const note =
  " Lorem ipsu, dolor sit amet consectetur adipisicing elit. Vitae, est eum magnam doloremque, at adipisci debitis, similique dolores ipsa unde necessitatibus vero quibusdam nostrum numquam!";

export const contactSection = {
  title: "contact us",
  heading: "How may we help you",
  description:
    "Discover our curated selection of stylish clothing for men and women, including trendy trousers and jackets.",
  directContactInfo: [
    {

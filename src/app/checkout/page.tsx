...
interface CountdownTimerProps {
  minutes: number; // specify that minutes should be a number
  onCancel: () => void; // specify that onCancel is a function with no parameters and no return value
}
// Timer component for countdown
const CountdownTimer: React.FC<CountdownTimerProps> = ({ minutes, onCancel }) => {
  ...
  return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          <h2 className="text-2xl mb-4">Time Remaining</h2>
...
const CheckoutPage = () => {
  ...
  return (
      <div className="nc-CheckoutPage">
        <main className="container py-16 lg:pb-28 lg:pt-20 ">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-[36%] ">
              ...
              <ButtonPrimary className="mt-8 w-full" onClick={() => setShowTimer(true)}>
                Confirm order
              </ButtonPrimary>
            </div>
          </div>
        ...
        {/* Show Timer Modal */}
        {showTimer && (
            <CountdownTimer minutes={10} onCancel={() => setShowTimer(false)} />
        )}
      </div>
  );
};
